-- ============================================================================
-- CREATE RPC FUNCTION FOR ATOMIC PROVIDER CREATION WITH MEMBERSHIP
-- ============================================================================
-- Migration: 20251027000000_create_provider_with_membership_rpc.sql
-- Date: October 27, 2025
-- Purpose: Create an RPC function that atomically creates a provider record
--          and the corresponding owner membership in provider_members table.
--          This ensures new providers can immediately access the dashboard.
-- ============================================================================

BEGIN;

-- ============================================================================
-- FUNCTION: create_provider_with_membership
-- ============================================================================
-- Purpose: Atomically create a provider and add the creating user as owner
-- Parameters: Provider data as JSONB
-- Returns: The created provider ID
-- Security: SECURITY DEFINER to bypass RLS for membership creation
-- ============================================================================
...
RAISE NOTICE '============================================================================';
RAISE NOTICE '';
RAISE NOTICE 'Function: public.create_provider_with_membership';
RAISE NOTICE 'Purpose: Atomically create provider + owner membership';
RAISE NOTICE 'Security: SECURITY DEFINER (bypasses RLS for membership creation)';
RAISE NOTICE '';
RAISE NOTICE 'Next Steps:';
RAISE NOTICE '  1. Update hooks/use-provider-onboarding.ts to call this RPC function';
RAISE NOTICE '  2. Test provider onboarding flow';
RAISE NOTICE '  3. Verify dashboard access works for new providers';
RAISE NOTICE '';
RAISE NOTICE '============================================================================';
