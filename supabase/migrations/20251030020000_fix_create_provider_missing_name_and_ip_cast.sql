-- ============================================================================
-- FIX create_provider_with_membership: Add missing name column and fix created_ip type
-- ============================================================================
-- Migration: 20251030020000_fix_create_provider_missing_name_and_ip_cast.sql
-- Changes:
--   - Add name column to INSERT (populated with business_name)
--   - Cast p_client_ip from TEXT to INET for created_ip column
-- ============================================================================

BEGIN;

-- Drop all existing variants to avoid overload ambiguity
...
-- Recreate function with name column and proper type casting
...
BEGIN
  ...
  -- FIX: Added name column and cast p_client_ip to INET
  INSERT INTO public.providers (
    ...
    p_user_id,
    p_business_name, -- FIX: Added name column (same as business_name)
    p_business_name,
    p_business_address,
    p_logo_url,
    p_description,
    ...
    p_user_id,
    p_client_ip::INET -- FIX: Cast TEXT to INET
